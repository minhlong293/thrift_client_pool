...
public class MultiSourceResult implements org.apache.thrift.TBase<MultiSourceResult, MultiSourceResult._Fields>, java.io.Serializable, Cloneable, Comparable<MultiSourceResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("MultiSourceResult");
  ...
  static {
    schemes.put(StandardScheme.class, new MultiSourceResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new MultiSourceResultTupleSchemeFactory());
  }
  ...
  public List<SourceDB> sources; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(MultiSourceResult.class, metaDataMap);
  }

  public MultiSourceResult() {
  }

  public MultiSourceResult(
    longhm.common.thrift.ReturnCode ReturnCode,
    List<SourceDB> sources)
  {
    this();
   ...
   */
  public MultiSourceResult(MultiSourceResult other) {
    if (other.isSetReturnCode()) {
      this.ReturnCode = other.ReturnCode;
    }
    if (other.isSetSources()) {
      List<SourceDB> __this__sources = new ArrayList<SourceDB>(other.sources.size());
      for (SourceDB other_element : other.sources) {
        __this__sources.add(new SourceDB(other_element));
      }
      this.sources = __this__sources;
    }
  }

  public MultiSourceResult deepCopy() {
    return new MultiSourceResult(this);
  }
   ...
   * @see longhm.common.thrift.ReturnCode
   */
  public MultiSourceResult setReturnCode(longhm.common.thrift.ReturnCode ReturnCode) {
    this.ReturnCode = ReturnCode;
    return this;
  }
  ...
  public java.util.Iterator<SourceDB> getSourcesIterator() {
    return (this.sources == null) ? null : this.sources.iterator();
  }

  public void addToSources(SourceDB elem) {
    if (this.sources == null) {
      this.sources = new ArrayList<SourceDB>();
    }
    this.sources.add(elem);
  }

  public List<SourceDB> getSources() {
    return this.sources;
  }

  public MultiSourceResult setSources(List<SourceDB> sources) {
    this.sources = sources;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SOURCES:
      if (value == null) {
        ...
        setSources((List<SourceDB>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof MultiSourceResult)
      return this.equals((MultiSourceResult)that);
    return false;
  }

  public boolean equals(MultiSourceResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(MultiSourceResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("MultiSourceResult(");
    boolean first = true;
  ...
  private static class MultiSourceResultStandardSchemeFactory implements SchemeFactory {
    public MultiSourceResultStandardScheme getScheme() {
      return new MultiSourceResultStandardScheme();
    }
  }

  private static class MultiSourceResultStandardScheme extends StandardScheme<MultiSourceResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, MultiSourceResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sources = new ArrayList<SourceDB>(_list60.size);
                SourceDB _elem61;
                for (int _i62 = 0; _i62 < _list60.size; ++_i62)
                {
                  _elem61 = new SourceDB();
                  _elem61.read(iprot);
                  struct.sources.add(_elem61);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, MultiSourceResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.sources != null) {
        oprot.writeFieldBegin(SOURCES_FIELD_DESC);
        {
          ...
          for (SourceDB _iter63 : struct.sources)
          {
            _iter63.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class MultiSourceResultTupleSchemeFactory implements SchemeFactory {
    public MultiSourceResultTupleScheme getScheme() {
      return new MultiSourceResultTupleScheme();
    }
  }

  private static class MultiSourceResultTupleScheme extends TupleScheme<MultiSourceResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, MultiSourceResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSources()) {
        {
          ...
          for (SourceDB _iter64 : struct.sources)
          {
            _iter64.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, MultiSourceResult struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.sources = new ArrayList<SourceDB>(_list65.size);
          SourceDB _elem66;
          for (int _i67 = 0; _i67 < _list65.size; ++_i67)
          {
            _elem66 = new SourceDB();
            _elem66.read(iprot);
            struct.sources.add(_elem66);
          }
        }
        struct.setSourcesIsSet(true);
      }
