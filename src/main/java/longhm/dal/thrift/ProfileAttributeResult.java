...
public class ProfileAttributeResult implements org.apache.thrift.TBase<ProfileAttributeResult, ProfileAttributeResult._Fields>, java.io.Serializable, Cloneable, Comparable<ProfileAttributeResult> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ProfileAttributeResult");
  ...
  private static final org.apache.thrift.protocol.TField PROFILE_ATTR_FIELD_DESC = new org.apache.thrift.protocol.TField("profileAttr", org.apache.thrift.protocol.TType.STRUCT, (short)2);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new ProfileAttributeResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new ProfileAttributeResultTupleSchemeFactory());
  }
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PROFILE_ATTR((short)2, "profileAttr");
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ProfileAttributeResult.class, metaDataMap);
  }
   ...
   */
  public ProfileAttributeResult(ProfileAttributeResult other) {
  ...
  public ProfileAttributeResult deepCopy() {
    return new ProfileAttributeResult(this);
  }
   ...
   * @see longhm.common.thrift.ReturnCode
   */
  public ProfileAttributeResult setReturnCode(longhm.common.thrift.ReturnCode ReturnCode) {
    this.ReturnCode = ReturnCode;
    return this;
  }
  ...
  public ProfileAttributeResult setProfileAttr(ProfileAttribute profileAttr) {
    this.profileAttr = profileAttr;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof ProfileAttributeResult)
      return this.equals((ProfileAttributeResult)that);
    return false;
  }

  public boolean equals(ProfileAttributeResult that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(ProfileAttributeResult other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("ProfileAttributeResult(");
    boolean first = true;
  ...
  private static class ProfileAttributeResultStandardSchemeFactory implements SchemeFactory {
    public ProfileAttributeResultStandardScheme getScheme() {
      return new ProfileAttributeResultStandardScheme();
    }
  }

  private static class ProfileAttributeResultStandardScheme extends StandardScheme<ProfileAttributeResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, ProfileAttributeResult struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ProfileAttributeResult struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class ProfileAttributeResultTupleSchemeFactory implements SchemeFactory {
    public ProfileAttributeResultTupleScheme getScheme() {
      return new ProfileAttributeResultTupleScheme();
    }
  }

  private static class ProfileAttributeResultTupleScheme extends TupleScheme<ProfileAttributeResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, ProfileAttributeResult struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, ProfileAttributeResult struct) throws org.apache.thrift.TException {
